    ...
    function (t, e) {
          ...
          if (
            ...
            if (16 === l.length) {
              ...
              (m.zOrigin &&
                ...
                (m.scaleY = (0 | (Math.sqrt(N * N + F * F) * y + 0.5)) / y),
                (m.scaleZ = (0 | (Math.sqrt(X * X + I * I) * y + 0.5)) / y),
                (m.skewX = 0),
                ...
                (m.z = U),
                m.svg &&
                  ((m.x -= m.xOrigin - (m.xOrigin * O - m.yOrigin * D)),
                  ...
                  O || S.skewX || E
                    ? ((O *= N),
                      ...
                      b &&
                        ...
                        S.skewY && ((e *= v), (s *= v))),
                      E &&
                        ((L += S.xOrigin - (S.xOrigin * e + S.yOrigin * i)),
                        (X += S.yOrigin - (S.xOrigin * s + S.yOrigin * n)),
                        (d = 1e-6),
                        d > L && L > -d && (L = 0),
                        d > X && X > -d && (X = 0)),
                      (x =
          ...
          'transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent',
          {
            parser: function (t, e, i, r, n, o, l) {
              ...
              var h,
                ...
                _,
                d,
                m = (r._transform = De(t, s, !0, l.parseTransform)),
                g = t.style,
                v = 1e-6,
                y = Te.length,
                x = l,
      ...
      ((h = a.prototype),
        ...
        (h._onInitTween = function (t, e, o) {
          ...
          if (
            ...
            for (
              ...
              d = d._next;
            ((x = new _e(t, 'transform', 0, 0, null, 2)),
              this._linkCSSP(x, null, d),
              (x.setRatio = we ? Le : Ne),
              (x.data = this._transform || De(t, s, !0)),
              (x.tween = o),
              (x.pr = -1),
              n.pop());
          }
          if (i) {
            for (; c; ) {
              ...
              ((c._prev = d ? d._prev : g) ? (c._prev._next = c) : (m = c),
                (c._next = d) ? (d._prev = c) : (g = c),
                (c = v));
            }
            this._firstPT = m;
          }
        ...
        (h._enableTransforms = function (t) {
          ((this._transform = this._transform || De(this._target, s, !0)),
            (this._transformType =
      ...
      var Ye = function (t, e, i) {
        var r, s, n, a;
        if (t.slice) for (s = t.length; --s > -1; ) Ye(t[s], e, i);
        else
...
(function (t) {
  ...
  var e,
    ...
    l = ',scrollTop,scrollLeft,show,hide,toggle,',
    _ = l,
    u = function (t, e) {
    ...
    p = function () {
      ...
      if (
        ((e = o.TweenMax || o.TweenLite),
        e &&
          ((r = (e.version + '.0.0').split('.')),
          (n = !(Number(r[0]) > 0 && Number(r[1]) > 7)),
          (o = o.com.greensock),
          ...
          !s &&
            ...
            (window.console.log(
              'The jquery.gsap.js plugin requires the TweenMax (or at least TweenLite and CSSPlugin) JavaScript file(s).' +
                (n ? ' Version ' + r.join('.') + ' is too old.' : ''),
            ),
            (s = !0)),
          void 0
        );
      if (t.easing) {
        for (a in c) t.easing[a] = f(c[a]);
        p = !1;
      }
    };
  ((t.fn.animate = function (s, n, h, l) {
    if (((s = s || {}), p && (p(), !e || !i))) return r.call(this, s, n, h, l);
    if (
      !a ||
      s.skipGSAP === !0 ||
      ('object' == typeof n && 'function' == typeof n.step)
    )
      return r.call(this, s, n, h, l);
    var f,
      m,
      d,
      g,
      v = t.speed(n, h, l),
      y = { ease: c[v.easing] || (v.easing === !1 ? c.linear : c.swing) },
      T = this,
      w = 'object' == typeof n ? n.specialEasing : null;
    for (m in s) {
      if (
        ((f = s[m]),
        f instanceof Array &&
        ...
        'show' === f ||
          'hide' === f ||
          'toggle' === f ||
          (-1 !== _.indexOf(m) && -1 !== _.indexOf(',' + m + ',')))
      )
        return r.call(this, s, n, h, l);
      y[-1 === m.indexOf('-') ? m : t.camelCase(m)] = f;
    }
    if (w) {
      ((y = o(y)), (g = []));
      for (m in w)
    ...
    return (
      (d = function (i) {
        ...
        if (g)
          for (s = g.length; --s > -1; )
            e.to(this, t.fx.off ? 0 : v.duration / 1e3, g[s]);
      ...
      if ((n.call(this, t, i), e)) {
        if (i)
          for (var s, r = e.getTweensOf(this), a = r.length; --a > -1; )
            ((s = r[a].totalTime() / r[a].totalDuration()),
              s > 0 && 1 > s && r[a].seek(r[a].totalDuration()));
        e.killTweensOf(this);
      }
      return this;
    }),
